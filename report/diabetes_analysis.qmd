...
![Accuracy of Logistic Regression and Linear SVC Model](../results/models/model_testing.png){#fig-model_testing}
...
![Ordinal Features Observations by Class](../results/figures/plot_ordinal_bar.png){#fig-ordinal_bar}
...
![Binary Features by Class](../results/figures/plot_binary_bar.png){#fig-binary_bar}
...
![Cross Validation Results of Candidate Models](../results/models/model_training.png){#fig-model_training}
